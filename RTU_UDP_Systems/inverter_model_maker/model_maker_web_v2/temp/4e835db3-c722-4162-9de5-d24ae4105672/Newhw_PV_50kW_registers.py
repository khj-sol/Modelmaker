# -*- coding: utf-8 -*-
"""
Newhw Inverter Modbus Register Map
Based on Newhw Modbus Protocol 
Protocol Name: newhw
...
class RegisterMap:
    ...
    REG_0X83                                 = 0x0083  # U16
    L2_VOLTAGE                               = 0x008A  # U16
    L1_CURRENT                               = 0x008E  # U16
    IEC_61727_MV800_60HZ                     = 0x0090  # U16
    L3_CURRENT                               = 0x009B  # U16
    ...
    ERROR_CODE2                              = BDEW_MV480
    ERROR_CODE3                              = PO12_3_MV480
...
class ErrorCode2:
    """Error Code Table2 (0x001C) — Bit field"""
    BITS = {
    }
...
class ErrorCode4:
    """Error Code Table4 (0x003F) — Bit field"""
    BITS = {
    }
...
class ErrorCode5:
    """Error Code Table5 (0x005A) — Bit field"""
    BITS = {
    }
...
class ErrorCode7:
    """Error Code Table7 (0x005C) — Bit field"""
    BITS = {
    }
...
class ErrorCode12:
    """Error Code Table12 (0x0072) — Bit field"""
    BITS = {
    }
...
class ErrorCode13:
    """Error Code Table13 (0x0073) — Bit field"""
    BITS = {
    }
...
class ErrorCode14:
    """Error Code Table14 (0x0102) — Bit field"""
    BITS = {
    }
...
class NewhwStatusConverter:
    """Newhw INVERTER_MODE register already contains InverterMode values."""
...
StatusConverter = NewhwStatusConverter
...
DATA_PARSER = {
    'mode                ': 'INVERTER_MODE',
    'r_voltage           ': 'DEA_L1_VOLTAGE (0x03EE~0x03EF); FILE_VERSION (0x0004); L1_VOLTAGE (0x000C)',
    's_voltage           ': 'DEA_L2_VOLTAGE (0x03F0~0x03F1); VDE_0126_1_1_BU (0x0005); L2_VOLTAGE (0x008A)',
    't_voltage           ': 'DEA_L3_VOLTAGE (0x03F2~0x03F3); L3_VOLTAGE (0x000E)',
    'r_current           ': 'DEA_L1_CURRENT (0x03E8~0x03E9); L1_CURRENT (0x008E)',
    's_current           ': 'DEA_L2_CURRENT (0x03EA~0x03EB); AS4777 (0x0013); C11_C10_MV480 (0x0029); NRS_097_2_1 (0x002D); L2_CURRENT (0xA4D8)',
    't_current           ': 'DEA_L3_CURRENT (0x03EC~0x03ED); L3_CURRENT (0x009B)',
    'frequency           ': 'DEA_FREQUENCY (0x03FA~0x03FB); FEATURE_DATA_SEQUENCENUMBER (0x0002); FREQUENCY (0x000F)',
    'ac_power            ': 'DEA_TOTAL_ACTIVE_POWER (0x03F4~0x03F5)',
    'cumulative_energy   ': 'CUMULATIVE_ENERGY (0x7D6A); TAI_MEA_MV480 (0x0023); NRS_097_2_1_MV480 (0x002E); ANRE_MV480 (0x0035); PRC_024_ERCOT_MV600 (0x0055); ABNORMAL_RESIDUAL_CURRENT (0x0803); BDEW_MV480 (0x001C)',
    'alarm1              ': 'FAULT_CODE',
