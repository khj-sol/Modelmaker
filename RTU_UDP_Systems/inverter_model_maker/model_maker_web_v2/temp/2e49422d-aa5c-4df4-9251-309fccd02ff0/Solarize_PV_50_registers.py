...
class ErrorCode2:
    """Error Code Table2 (0x0005) — Bit field"""
    BITS = {
    }
...
class ErrorCode4:
    """Error Code Table4 (0x101F) — Bit field"""
    BITS = {
    }
...
class ErrorCode5:
    """Error Code Table5 (0x1020) — Bit field"""
    BITS = {
    }
...
DATA_PARSER = {
    'mode                ': 'INVERTER_MODE',
    'r_voltage           ': 'DEA_L1_VOLTAGE (0x03EE~0x03EF); INTERNAL_STORAGE_ERROR (0x000C); L1_VOLTAGE (0x0026); GFCI_ABNORMAL (0x0004)',
    's_voltage           ': 'DEA_L2_VOLTAGE (0x03F0~0x03F1); L2_VOLTAGE (0x000D); PV_STRING_REVERSE (0x0005)',
    ...
    'frequency           ': 'DEA_FREQUENCY (0x03FA~0x03FB); REGISTER_NUMBER (0x0002); FREQUENCY (0x000F)',
